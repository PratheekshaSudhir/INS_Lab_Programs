def feistel_round(L, R, K):
    # One round of the Feistel cipher.Uses a simple round function: f(R, K) = (sum of ASCII values of R + K) % 256.
...
def feistel_decrypt(ciphertext, round_keys):
    #Decrypts a string ciphertext using Feistel cipher.Uses the round keys in reverse order.
